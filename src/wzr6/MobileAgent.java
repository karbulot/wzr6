...
// ----------------------------------------
   int dlugosc_pauzy = 102;  // długość przerwy w animacji w [ms]
   long maks_liczba_epizodow = 10000000;
...
// ------------------------
	...
	if (msg2!=null)
        ...
        msg_o_strat.setConversationId("Inform_o_strategii");
	    ...
	    public void action() {
                ...
                if (met_uczenia == UCZENIE_ZE_WZMOCNIENIEM)
                {
                    if (uzw.numer_epizodu < maks_liczba_epizodow)
                    {
                        ...
                        if (System.currentTimeMillis()-czas < 2018)
                        {
